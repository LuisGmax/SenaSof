    ...
    try {
        ...
        if (con != null) {
            ...
            if (rs.next()) {
                ...
                usua.setEmail(rs.getString("correo"));
                usua.setIdRegion(rs.getString("id_region"));
    ...
    return usua; // Devuelve el usuario encontrado o vacío
      ...
      public boolean crear(Usuario us){
        try{
           ...
           pstm.setString(4, us.getUsuario());
           pstm.setString(5, us.getContrasena());
           pstm.setString(6, us.getEmail());
           pstm.setString(7, us.getIdRegion());
           pstm.setString(8, us.getDireccion());
